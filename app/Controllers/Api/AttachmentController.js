const { ATTACHMENT_TYPES, INSTANCE_TYPES } = require("../../config/enum");
const { validateAll, validateAsync } = require("../../Helper");
    ...
    switch (action) {
      case "store":
        rules = {
            ...
            "type": "required|integer|in:" + Object.values(ATTACHMENT_TYPES).join(","),
            "thumbnail": "string",
            "blur_image": "string",
            "instance_type": "required|integer|in:" + Object.values(INSTANCE_TYPES).join(","),
            "instance_id": "integer"
        }
