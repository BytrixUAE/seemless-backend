...
class UserSocialAccountController extends RestController {
  constructor() {
    super('UserSocialAccount');
    this.resource = "UserSocialAccount";
    this.request; 
    this.response;
    this.params = {};
  }
...
module.exports = UserSocialAccountController;